...
__webpack_require__.d(__webpack_exports__, {
  ...
  extractFromJson: () => (/* reexport */ extractFromJson),
  extractFromXml: () => (/* reexport */ extractFromXml)
});

;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/src/utils/linker.js
// utils -> linker
const isValid = (url = "") => {
    try {
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/src/utils/retrieve.js
// utils -> retrieve
...
/* harmony default export */ const retrieve = (async (url, fetcher) => {
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/deps/jsr.io/@pwshub/bellajs/13.1.0/src/detection.js
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/deps/jsr.io/@pwshub/bellajs/13.1.0/src/string.js
/** String manipulation utilities. */

const string_toString = (input) => {
    return !detection_isString(input) ? String(input) : input;
};
/**
 * Truncates text to a specified word count using Intl.Segmenter.
 * Works with any language.
 */
const truncateByWord = (text, wordLimit = 0) => {
    if (!text)
        return "";
    if (wordLimit <= 0) {
        return text;
 ...
 */
const truncateByChar = (text, charLimit = 0) => {
    if (!text)
        return "";
    if (charLimit <= 0)
        return text;
...
const truncateByGrapheme = (/* unused pure expression or super */ null && (truncateByChar));
/**
 * Truncates text to a specified number of Unicode code points.
 * Safe for PostgreSQL VARCHAR columns.
 */
const truncateByCodePoint = (text, max = 250) => {
    if (!text)
        return "";
    const chars = [...text];
    if (chars.length <= max)
 ...
 */
const truncateByByte = (text, maxBytes = 255) => {
    if (!text)
        return "";
...
const truncate = (/* unused pure expression or super */ null && (truncateByWord));
/** Removes all HTML tags from a string. */
const stripTags = (s) => {
    return string_toString(s).replace(/(<([^>]+)>)/ig, "").trim();
};
/** Escapes HTML special characters to entity equivalents. */
const escapeHTML = (s) => {
    return string_toString(s)
        .replace(/&/g, "&amp;")
        .replace(/</g, "&lt;")
        .replace(/>/g, "&gt;")
        .replace(/"/g, "&quot;");
...
const ucfirst = (s) => {
    const x = string_toString(s).toLowerCase();
    return x.length > 1
...
const ucwords = (s) => {
    return string_toString(s).split(" ").map((w) => {
        return ucfirst(w);
    }).join(" ");
};
...
const stripAccent = (s) => {
    ...
    return string_toString(s).replace(/[^\u0000-\u007E]/g, (a) => {
...
const getArrayOfWords = (text, lang) => {
    if (!text)
        return [];
...
const findWordsInWithRegExp = (text, words = []) => {
    if (!text || !words.length)
        return [];
...
const getTTR = (text, imgcount = 0, wordsPerMinute = 268) => {
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/deps/jsr.io/@pwshub/bellajs/13.1.0/src/random.js
/** Cryptographically secure random utilities. */
const random_crypto = globalThis.crypto;
...
const genid = (len = 32, prefix = "") => {
    ...
    random_crypto.getRandomValues(bytes);
    let id = prefix;
    let i = 0;
    ...
    while (id.length < len) {
        ...
        random_crypto.getRandomValues(extraBytes);
        let j = 0;
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/deps/jsr.io/@pwshub/bellajs/13.1.0/src/date.js
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/deps/jsr.io/@pwshub/bellajs/13.1.0/src/array.js
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/deps/jsr.io/@pwshub/bellajs/13.1.0/src/rating.js
 ...
 */
const bayesianAverage = (ratings = [], prior = 5, priorMean = 3) => {
...
const weightedRating = (ratings = [], halfLife = 24) => {
...
const viralScore = ({ engagement = 0, rating = 1, ageInHours = 0, windowSize = 24, } = {}) => {
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/deps/jsr.io/@pwshub/bellajs/13.1.0/mod.js
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/src/utils/xmlparser.js
// utils / xmlparser


const isRSS = (data = {}) => {
    return detection_hasProperty(data, "rss") &&
        detection_hasProperty(data.rss, "channel");
};
const isAtom = (data = {}) => {
    return detection_hasProperty(data, "feed") &&
        detection_hasProperty(data.feed, "entry");
};
const isRdf = (data = {}) => {
    return detection_hasProperty(data, "rdf:RDF") &&
        detection_hasProperty(data["rdf:RDF"], "channel");
};
const xmlparser_validate = (xml) => {
    if (!detection_isString(xml) || !xml.length)
        return false;
    return XMLValidator.validate(xml) === true;
};
const xml2obj = (xml = "", extraOptions = {}) => {
    const options = {
        attributeNamePrefix: "@_",
        ignoreAttributes: false,
        ...extraOptions,
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/deps/jsr.io/@std/html/1.0.7/entities.js
 ...
 */
function entities_unescape(str, options = {}) {
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/src/utils/normalizer.js
// normalizer
...
const buildDescription = (val, maxlen = 0) => {
...
const getText = (val) => {
    const txt = isObject(val)
        ? (val._text ||
            ...
            val.$t)
        : val;
    return txt ? entities_unescape(String(txt).trim()) : "";
};
const getLink = (val = [], id = "") => {
    if (isObject(id) &&
        detection_hasProperty(id, "@_isPermaLink") &&
    ...
    const url = detection_isString(val)
        ? getText(val)
        : isObject(val) && detection_hasProperty(val, "href")
            ? getText(val.href)
            : isObject(val) && detection_hasProperty(val, "@_href")
                ? getText(val["@_href"])
                : isObject(val) && detection_hasProperty(val, "@_url")
                    ? getText(val["@_url"])
                    : isObject(val) &&
                        detection_hasProperty(val, "_attributes")
                        ? getText(val._attributes
                            .href)
                        : isArray(val)
                            ? getEntryLink(val)
                            : "";
...
const getPureUrl = (url, id = "", baseUrl = "") => {
...
const getEntryId = (id, url, pubDate) => {
    return id
        ? getText(id)
        : hash(getPureUrl(url)) + "-" + (new Date(pubDate)).getTime();
};
const getEnclosure = (val) => {
    const url = detection_hasProperty(val, "@_url") ? val["@_url"] : "";
    const type = detection_hasProperty(val, "@_type") ? val["@_type"] : "";
    const length = Number(detection_hasProperty(val, "@_length") ? val["@_length"] : 0);
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/src/utils/parseJsonFeed.js
// parseJsonFeed.ts
...
const transform = (item, options) => {
    const { useISODateFormat, descriptionMaxLen, baseUrl, getExtraEntryFields, } = options;
    const { id = "", title = "", url: link = "", date_published: pubDate = "", summary = "", content_html: htmlContent = "", content_text: textContent = "", } = item;
...
const parseJson = (data, options) => {
    const { normalization, baseUrl, getExtraFeedFields, } = options;
    if (!normalization) {
        return data;
    }
    const { title = "", home_page_url: homepageUrl = "", date_published: pubDate = "", date_modified: modDate = "", description = "", language = "", items: item = [], } = data;
    const extraFields = getExtraFeedFields(data);
    const items = isArray(item) ? item : [item];
    return {
        title,
        link: purify(homepageUrl) ||
            absolutify(baseUrl, homepageUrl),
        description,
        language,
...
/* harmony default export */ const parseJsonFeed = ((data, options = {}) => {
    return parseJson(data, options);
});

;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/src/utils/parseRssFeed.js
// parseRssFeed.ts
// specs: https://www.rssboard.org/rss-specification


const parseRssFeed_transform = (item, options) => {
    const { useISODateFormat, descriptionMaxLen, baseUrl, getExtraEntryFields, } = options;
    const { guid = "", title = "", link = "", pubDate = "", description = "", "content:encoded": content = "", } = item;
    const published = useISODateFormat
        ? toISODateString(pubDate)
        : pubDate;
...
const parseRssFeed_flatten = (feed, baseUrl) => {
...
const parseRss = (data, options = {}) => {
    const { normalization, baseUrl, getExtraFeedFields, } = options;
    const feedData = data.rss
        .channel;
    if (!normalization) {
        return parseRssFeed_flatten(feedData, baseUrl);
    }
    const { title = "", link = "", description = "", generator = "", language = "", lastBuildDate = "", item = [], } = feedData;
    ...
    return {
        ...
        ...extraFields,
        entries: items.map((item) => {
            return parseRssFeed_transform(item, options);
        }),
    };
};
/* harmony default export */ const parseRssFeed = ((data, options = {}) => {
    return parseRss(data, options);
});

;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/src/utils/parseAtomFeed.js
// parseAtomFeed.ts
// specs: https://datatracker.ietf.org/doc/html/rfc5023
// refer: https://validator.w3.org/feed/docs/atom.html


const parseAtomFeed_transform = (item, options) => {
    const { useISODateFormat, descriptionMaxLen, baseUrl, getExtraEntryFields, } = options;
    const { id = "", title = "", issued = "", modified = "", updated = "", published = "", link = "", summary = "", content = "", } = item;
...
const parseAtomFeed_flatten = (feed, baseUrl) => {
    ...
    const items = entries.map((entry) => {
        ...
        if (detection_hasProperty(entry, "summary")) {
            item.summary = getText(summary);
        }
        if (detection_hasProperty(entry, "content")) {
...
const parseAtom = (data, options = {}) => {
    ...
    if (!normalization) {
        return parseAtomFeed_flatten(feedData, baseUrl);
    }
    const { id = "", title = "", link = "", subtitle = "", generator = "", language = feedData.language || feedData["@_xml:lang"] || "", updated = "", entry: item = [], } = feedData;
    const extraFields = getExtraFeedFields(feedData);
    const items = isArray(item) ? item : [item];
    const published = options.useISODateFormat
    ...
    return {
        ...
        ...extraFields,
        entries: items.map((item) => {
            return parseAtomFeed_transform(item, options);
        }),
    };
};
/* harmony default export */ const parseAtomFeed = ((data, options = {}) => {
    return parseAtom(data, options);
});

;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/src/utils/parseRdfFeed.js
// parseRdfFeed.ts
// specs: https://www.rssboard.org/rss-specification


const parseRdfFeed_transform = (item, options) => {
    const { useISODateFormat, descriptionMaxLen, baseUrl, getExtraEntryFields, } = options;
    const { guid = "", title = "", link = "", "dc:date": pubDate = "", description = "", "content:encoded": content = "", } = item;
    const published = useISODateFormat
        ? toISODateString(pubDate)
        : pubDate;
    const htmlContent = getText(description || content);
...
const parseRdfFeed_flatten = (feed, baseUrl) => {
    const { title = "", link = "", item, } = feed;
    const items = isArray(item) ? item : [item];
    const entries = items.map((entry) => {
        const { id, title = "", link = "", } = entry;
...
const parseRdf = (data, options = {}) => {
    ...
    if (!normalization) {
        return parseRdfFeed_flatten(feedData, baseUrl);
    }
    const { title = "", link = "", description = "", generator = "", "dc:language": language = "", "dc:date": lastBuildDate = "", } = feedData.channel;
    const { item } = feedData;
    const extraFields = getExtraFeedFields(feedData);
    const items = isArray(item) ? item : [item];
    const published = options.useISODateFormat
    ...
    return {
        ...
        ...extraFields,
        entries: items.map((item) => {
            return parseRdfFeed_transform(item, options);
        }),
    };
};
/* harmony default export */ const parseRdfFeed = ((data, options = {}) => {
    return parseRdf(data, options);
});

;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/src/main.js
// main.ts
...
const getopt = (options = {}) => {
    const { normalization = true, descriptionMaxLen = 250, useISODateFormat = true, xmlParserOptions = {}, baseUrl = "", getExtraFeedFields = () => ({}), getExtraEntryFields = () => ({}), } = options;
    return {
        normalization,
        descriptionMaxLen,
        useISODateFormat,
 ...
 */
const extractFromJson = (json, options = {}) => {
    const data = typeof json === "string" ? JSON.parse(json) : json;
    return parseJsonFeed(data, getopt(options));
};
/**
 ...
 */
const extractFromXml = (xml, options = {}) => {
    if (!xmlparser_validate(xml)) {
 ...
 */
const extract = async (url, options = {}, fetcher = globalThis.fetch) => {
    if (!isValid(url)) {
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/esm/mod.js
