...
__webpack_require__.d(__webpack_exports__, {
  ...
  extractFromJson: () => (/* binding */ extractFromJson),
  extractFromXml: () => (/* binding */ extractFromXml),
  read: () => (/* binding */ read)
});

;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/src/utils/linker.js
// utils -> linker
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/src/utils/retrieve.js
// utils -> retrieve
 ...
 */
/* harmony default export */ const retrieve = (async (url, options = {}) => {
  const {
    headers = {
...
;// CONCATENATED MODULE: ./node_modules/@pwshub/bellajs/src/detection.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@pwshub/bellajs/src/string.js
...
const stripAccent = (s) => {
  ...
  return string_toString(s).replace(/[^\u0000-\u007E]/g, (a) => accentMap.get(a) || a)
}
...
;// CONCATENATED MODULE: ./node_modules/@pwshub/bellajs/src/random.js
...
;// CONCATENATED MODULE: ./node_modules/@pwshub/bellajs/src/date.js
...
;// CONCATENATED MODULE: ./node_modules/@pwshub/bellajs/src/array.js
...
;// CONCATENATED MODULE: ./node_modules/@pwshub/bellajs/src/rating.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@pwshub/bellajs/src/index.js
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/src/utils/xmlparser.js
// utils / xmlparser
 ...
 */
const isRSS = (data = {}) => {
  return detection_hasProperty(data, 'rss') && detection_hasProperty(data.rss, 'channel')
}
 ...
 */
const isAtom = (data = {}) => {
  return detection_hasProperty(data, 'feed') && detection_hasProperty(data.feed, 'entry')
}
 ...
 */
const isRdf = (data = {}) => {
  return detection_hasProperty(data, 'rdf:RDF') && detection_hasProperty(data['rdf:RDF'], 'channel')
}
...
const xmlparser_validate = (xml) => {
  return (!detection_isString(xml) || !xml.length) ? false : XMLValidator.validate(xml) === true
}
...
var surrogate_pairs_fromCodePoint = String.fromCodePoint ||
    function (astralCodePoint) {
        return String.fromCharCode(Math.floor((astralCodePoint - 0x10000) / 0x400) + 0xd800, ((astralCodePoint - 0x10000) % 0x400) + 0xdc00);
    };
// @ts-expect-error - String.prototype.codePointAt might not exist in older node versions
var surrogate_pairs_getCodePoint = String.prototype.codePointAt
...
var allNamedReferences = esm_assign(esm_assign({}, namedReferences), { all: namedReferences.html5 });
var encodeRegExps = {
    specialChars: /[<>'"&]/g,
    nonAscii: /[<>'"&\u0080-\uD7FF\uE000-\uFFFF\uDC00-\uDFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]?/g,
...
var decodeRegExps = esm_assign(esm_assign({}, baseDecodeRegExps), { all: baseDecodeRegExps.html5 });
        ...
        if (decodeResultByReference) {
            ...
            decodeResult =
                decodeCode >= 0x10ffff
                    ? outOfBoundsChar
                    : decodeCode > 65535
                        ? surrogate_pairs_fromCodePoint(decodeCode)
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/src/utils/normalizer.js
// normalizer
...
const getLink = (val = [], id = '') => {
  if (isObject(id) && detection_hasProperty(id, '@_isPermaLink') && id['@_isPermaLink'] === 'true') {
    return getText(id)
  }
    ...
    : isObject(val) && detection_hasProperty(val, 'href')
      ...
      : isObject(val) && detection_hasProperty(val, '@_href')
        ...
        : isObject(val) && detection_hasProperty(val, '@_url')
          ? getText(val['@_url'])
          : isObject(val) && detection_hasProperty(val, '_attributes')
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/src/utils/parseJsonFeed.js
// parseJsonFeed.js
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/src/utils/parseRssFeed.js
// parseRssFeed.js
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/src/utils/parseAtomFeed.js
// parseAtomFeed.js
...
const parseAtomFeed_flatten = (feed, baseUrl) => {
  ...
  const items = entries.map((entry) => {
    ...
    if (detection_hasProperty(item, 'summary')) {
      item.summary = getText(summary)
    }
    if (detection_hasProperty(item, 'content')) {
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/src/utils/parseRdfFeed.js
// parseRssFeed.js
...
;// CONCATENATED MODULE: ./node_modules/@extractus/feed-extractor/src/main.js
// main.js
 ...
 */
const read = async (url, options, fetchOptions) => {
